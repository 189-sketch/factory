...
events, and accepts scoped progress or semantic outcome updates. An agent can
checkpoint clean committed work, stop with `needs-input`, and resume from that
exact commit after an operator answer.
