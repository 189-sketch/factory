 ...
 *
 * Binds the registry HTTP API to a local address. Electron mode embeds this
 * same package in the main process (A4 §6); this file is only the Web-mode
 * process bootstrap and stays minimal.
 *
 * Config via env:
